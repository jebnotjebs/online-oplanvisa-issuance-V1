<?php
include "Actions/verify-client.php";
include "header.php";
if(isset($_GET['userid'])){
    $num = $_GET["userid"];
    $sql = "SELECT * FROM tbl_users WHERE userid = $num";
...
<head>
    ...
    <link rel="stylesheet" href="Css/register-form.css"> <!-- these are main CSS -->
     <link rel="stylesheet" href="dist/css/adminlte.min.css"> <!-- these are templates -->
    <link rel="stylesheet" href="plugins/fontawesome-free/css/all.min.css"> <!-- these are icons -->
        ...
        if(isset($_GET['userid'])){
          ...
          <div class="alert col-lg-6"> 
            <div class="alert alert-success alert-dismissible fade show">
                <strong>Hello <?php echo $row["userEml"]; ?></strong> Please fill-out all the assigned form.
         ...
         ?>
          <?php
        if(isset($_GET['error'])){
          if($_GET['error'] == "youalreadysubmitted"){ ?>
          <div class="alert col-lg-6"> 
            <div class="alert alert-danger alert-dismissible fade show">
                <strong>Opps! </strong> Looks like you already submitted your registration form. Please give us some time to review your form.
                <button type="button" class="btn-close" data-bs-dismiss="alert"></button>
            </div>
            </div>
         ...
         ?>
                ...
                <br>
                <h1 class="header"><p class="text-center text-light"> Registration Form</p></h1>
                <br>
    </div>
    <div class="container">
