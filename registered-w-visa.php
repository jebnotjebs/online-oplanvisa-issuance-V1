...
include "Actions/verify-admin.php";
 if(isset($_GET['error'])){
    ...
    $sql0 = "SELECT * FROM tbl_registered_visa";
...
<body class="hold-transition sidebar-mini">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <nav class="mt-2">
                ...
                <li class="nav-item">
                    <a href="registered-w-visa.php" class="nav-link active">
                    <i class="nav-icon fas fa-id-card"></i>
                    <p>
                  Registered member
                    </p>
                                    ...
                                    <div class="d-grid gap-2 col-3 mx-auto">
                                        ...
                                        <div class="modal fade" id="exampleModalToggle" aria-hidden="true" aria-labelledby="exampleModalToggleLabel" tabindex="-1">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalToggleLabel">Notice: You are about to register this person</h5>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                </div>
                                        ...
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                ...
                                                <div class="card card-primary">
                                                    ...
                                                    <div class="modal-footer justify-content-between">
                                                    <button type="button" class="btn btn-danger" data-dismiss="modal"><i class="fa fa-times"></i> Close</button>
                                                    <a href = "Admin-actions/print.php?userid=<?php echo $row['userid'] ?>" class="btn btn-primary"> Print</a>
