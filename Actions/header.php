    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark sticky-top">
            <div class="container-fluid">
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                    <a class="nav-link" aria-current="page" href="../announcement.php">Announcement</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                    <a class="nav-link" href="../user-login.php" onclick="return confirm('Are you sure?')">Logout</a>
